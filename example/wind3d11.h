...
int example() {
	...
	::RegisterClassExW(&wc);
	HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"File Selector Example", WS_OVERLAPPEDWINDOW, 100, 100, (int)(1280 * mainScale), (int)(800 * mainScale), nullptr, nullptr, wc.hInstance, nullptr);
